...
import 'package:mershed/ui/screens/SplashScreen.dart';
import 'package:mershed/ui/screens/onboarding_screen.dart'; // Import onboarding screen
...
import '../ui/screens/TripDetailScreen.dart';

class AppRoutes {
  static const String splash = '/splash';
  static const String onboarding = '/onboarding'; // New onboarding route
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case onboarding: // Add onboarding case
      ...
      case tripDetail:
        ...
        if (trip == null) {
          return MaterialPageRoute(
            builder: (_) => const Scaffold(
              body: Center(child: Text('Trip data not provided')),
            ),
          );
        }
        return MaterialPageRoute(
  ...
  static Map<String, WidgetBuilder> get routes => {
    ...
    tripDetail: (context) {
      ...
      if (args == null) {
        return const Scaffold(body: Center(child: Text('Trip data not provided')));
      }
...
import 'package:mershed/ui/screens/preferences_screen.dart';
import 'package:mershed/ui/screens/profile_screen.dart';
import 'package:mershed/ui/screens/SplashScreen.dart'; // Import splash screen
import 'package:provider/provider.dart';
...
class AppRoutes {
  // Existing routes
  static const String splash = '/splash'; // New splash route
  static const String login = '/login';
  static const String home = '/home';
  static const String trip = '/trip';
  static const String map = '/map';
